...
![Hydromechanical (HGI) and Batch-Collection Grease Interceptor Level Monitor banner](banner.png)
...
![Wiring diagram: A02YYUW sensor → Notecarrier CX header pins; 5 V DC wall adapter → +VBAT pad; CEL-16432 antenna → SMA on Notecarrier CX](diagrams/02-wiring-assembly.svg)
