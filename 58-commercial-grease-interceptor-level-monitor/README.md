...
| [Taoglas FXP73.07.0150A](https://www.taoglas.com/product/fxp73/) flexible LTE/NB-IoT antenna, u.FL, 150 mm lead | 1 | Adhesive-mount inside the polycarbonate lid — polycarbonate is RF-transparent, so no external hole or seal penetration is required. Rated −40 to +85 °C; compatible with all MBGLW LTE Cat-1 bis bands. |
