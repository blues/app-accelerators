...
The scripts use the Notehub API, so you'll need follow the [instructions here](https://dev.blues.io/api-reference/notehub-api/) to get an authentication token.
