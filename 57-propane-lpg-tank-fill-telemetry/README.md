...
3. **Configure fleet variables in Notehub** — Set these in **Projects → Environment (tab)** at the Fleet level:
   ...
   - All others have sensible defaults; see [§7](#6-notehub-setup) for the full list.
