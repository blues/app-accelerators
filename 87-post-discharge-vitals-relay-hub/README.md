...
![Post-Discharge Vitals Relay Hub banner](banner.png)
...
![System architecture: BLE patient devices (weight scale, BP cuff, pulse oximeter, activity band) → Feather nRF52840 BLE Central on Notecarrier F with Notecard MBGLW → cellular (LTE Cat-1 bis) → Notehub → care-coordinator alert route and analytics / EHR route](diagrams/01-system-architecture.svg)
