...
#ifndef _VL53L4CX_LL_DEVICE_H_
#define _VL53L4CX_LL_DEVICE_H_

#include "vl53l4cx_platform_user_config.h"
#include "vl53l4cx_types.h"

#define   VL53L4CX_I2C                      0x01
#define   VL53L4CX_SPI                      0x00





typedef uint8_t VL53L4CX_WaitMethod;

#define VL53L4CX_WAIT_METHOD_BLOCKING               ((VL53L4CX_WaitMethod)  0)
#define VL53L4CX_WAIT_METHOD_NON_BLOCKING           ((VL53L4CX_WaitMethod)  1)




typedef uint8_t VL53L4CX_DeviceState;

#define VL53L4CX_DEVICESTATE_POWERDOWN              ((VL53L4CX_DeviceState)  0)
#define VL53L4CX_DEVICESTATE_HW_STANDBY             ((VL53L4CX_DeviceState)  1)
#define VL53L4CX_DEVICESTATE_FW_COLDBOOT            ((VL53L4CX_DeviceState)  2)
#define VL53L4CX_DEVICESTATE_SW_STANDBY             ((VL53L4CX_DeviceState)  3)
#define VL53L4CX_DEVICESTATE_RANGING_DSS_AUTO       ((VL53L4CX_DeviceState)  4)
#define VL53L4CX_DEVICESTATE_RANGING_DSS_MANUAL     ((VL53L4CX_DeviceState)  5)
#define VL53L4CX_DEVICESTATE_RANGING_WAIT_GPH_SYNC  ((VL53L4CX_DeviceState)  6)
#define VL53L4CX_DEVICESTATE_RANGING_GATHER_DATA    ((VL53L4CX_DeviceState)  7)
#define VL53L4CX_DEVICESTATE_RANGING_OUTPUT_DATA    ((VL53L4CX_DeviceState)  8)

#define VL53L4CX_DEVICESTATE_UNKNOWN               ((VL53L4CX_DeviceState) 98)
#define VL53L4CX_DEVICESTATE_ERROR                 ((VL53L4CX_DeviceState) 99)
...
typedef uint8_t VL53L4CX_DevicePresetModes;

#define VL53L4CX_DEVICEPRESETMODE_NONE                            \
  ((VL53L4CX_DevicePresetModes)  0)
#define VL53L4CX_DEVICEPRESETMODE_HISTOGRAM_LONG_RANGE            \
  ((VL53L4CX_DevicePresetModes) 27)
#define VL53L4CX_DEVICEPRESETMODE_HISTOGRAM_MEDIUM_RANGE          \
  ((VL53L4CX_DevicePresetModes) 30)
#define VL53L4CX_DEVICEPRESETMODE_HISTOGRAM_SHORT_RANGE           \
  ((VL53L4CX_DevicePresetModes) 33)
