...
#ifndef _VL53L4CX_LL_DEF_H_
#define _VL53L4CX_LL_DEF_H_
...
#define VL53L4CX_LL_API_IMPLEMENTATION_VER_MAJOR       1

#define VL53L4CX_LL_API_IMPLEMENTATION_VER_MINOR       1

#define VL53L4CX_LL_API_IMPLEMENTATION_VER_SUB         1

#define VL53L4CX_LL_API_IMPLEMENTATION_VER_REVISION   0

#define VL53L4CX_LL_API_IMPLEMENTATION_VER_STRING "1.1.1"


#define VL53L4CX_FIRMWARE_VER_MINIMUM         398
#define VL53L4CX_FIRMWARE_VER_MAXIMUM         400




#define VL53L4CX_LL_CALIBRATION_DATA_STRUCT_VERSION       0xECAB0102




#define VL53L4CX_LL_ZONE_CALIBRATION_DATA_STRUCT_VERSION  0xECAE0101





#define VL53L4CX_BIN_REC_SIZE 6

#define VL53L4CX_TIMING_CONF_A_B_SIZE 2

#define VL53L4CX_FRAME_WAIT_EVENT 6




#define VL53L4CX_MAX_XTALK_RANGE_RESULTS        5


#define VL53L4CX_MAX_OFFSET_RANGE_RESULTS       3


#define VL53L4CX_NVM_MAX_FMT_RANGE_DATA         4


#define VL53L4CX_NVM_PEAK_RATE_MAP_SAMPLES  25

#define VL53L4CX_NVM_PEAK_RATE_MAP_WIDTH     5

#define VL53L4CX_NVM_PEAK_RATE_MAP_HEIGHT     5




#define VL53L4CX_ERROR_DEVICE_FIRMWARE_TOO_OLD           ((VL53L4CX_Error) - 80)

#define VL53L4CX_ERROR_DEVICE_FIRMWARE_TOO_NEW           ((VL53L4CX_Error) - 85)

#define VL53L4CX_ERROR_UNIT_TEST_FAIL                    ((VL53L4CX_Error) - 90)

#define VL53L4CX_ERROR_FILE_READ_FAIL                    ((VL53L4CX_Error) - 95)

#define VL53L4CX_ERROR_FILE_WRITE_FAIL                   ((VL53L4CX_Error) - 96)
...
} VL53L4CX_xtalkextract_config_t;
...
typedef struct {
  ...
  VL53L4CX_DeviceSscArray  array_select;
...
} VL53L4CX_tuning_parm_storage_t;
...
typedef struct {
  ...
  VL53L4CX_histogram_config_t multizone_hist_cfg;

  VL53L4CX_user_zone_t user_zones[VL53L4CX_MAX_USER_ZONES];


  uint8_t bin_config[VL53L4CX_MAX_USER_ZONES];


} VL53L4CX_zone_config_t;
...
typedef struct {
  ...
  VL53L4CX_GPIO_Interrupt_Mode  intr_mode_distance;


  VL53L4CX_GPIO_Interrupt_Mode  intr_mode_rate;
...
} VL53L4CX_GPIO_interrupt_config_t;
...
} VL53L4CX_low_power_auto_data_t;
...
} VL53L4CX_smudge_corrector_config_t;
...
} VL53L4CX_smudge_corrector_internals_t;
...
} VL53L4CX_smudge_corrector_data_t;
...
typedef struct {
  ...
  uint32_t   VL53L4CX_p_016;

  uint32_t   VL53L4CX_p_017;
  ...
  uint16_t   VL53L4CX_p_026;

  uint16_t   VL53L4CX_p_011;

  uint16_t   VL53L4CX_p_027;
...
typedef struct {
  ...
  VL53L4CX_DeviceState     cfg_device_state;

  VL53L4CX_DeviceState     rd_device_state;
  ...
  int16_t                VL53L4CX_p_022[VL53L4CX_MAX_AMBIENT_DMAX_VALUES];
  ...
  VL53L4CX_range_data_t    VL53L4CX_p_003[VL53L4CX_MAX_RANGE_RESULTS];

  VL53L4CX_range_data_t    xmonitor;

  VL53L4CX_smudge_corrector_data_t smudge_corrector_data;


} VL53L4CX_range_results_t;
...
typedef struct {
  ...
  VL53L4CX_xtalk_range_data_t
  VL53L4CX_p_003[VL53L4CX_MAX_XTALK_RANGE_RESULTS];

  VL53L4CX_histogram_bin_data_t central_histogram_sum;

  VL53L4CX_histogram_bin_data_t central_histogram_avg;

  uint8_t central_histogram__window_start;

  uint8_t central_histogram__window_end;

  VL53L4CX_histogram_bin_data_t
  histogram_avg_1[VL53L4CX_MAX_XTALK_RANGE_RESULTS];

  VL53L4CX_histogram_bin_data_t
  histogram_avg_2[VL53L4CX_MAX_XTALK_RANGE_RESULTS];

  VL53L4CX_histogram_bin_data_t
  xtalk_avg[VL53L4CX_MAX_XTALK_RANGE_RESULTS];


} VL53L4CX_xtalk_range_results_t;
...
typedef struct {
  ...
  VL53L4CX_offset_range_data_t
  VL53L4CX_p_003[VL53L4CX_MAX_OFFSET_RANGE_RESULTS];


} VL53L4CX_offset_range_results_t;
...
} VL53L4CX_additional_offset_cal_data_t;
...
} VL53L4CX_per_vcsel_period_offset_cal_data_t;
...
typedef struct {
  ...
  VL53L4CX_object_data_t   VL53L4CX_p_003[VL53L4CX_MAX_RANGE_RESULTS];


  VL53L4CX_object_data_t   xmonitor;


} VL53L4CX_zone_objects_t;
...
typedef struct {
  ...
  VL53L4CX_zone_objects_t VL53L4CX_p_003[VL53L4CX_MAX_USER_ZONES];


} VL53L4CX_zone_results_t;
...
typedef struct {
  ...
  VL53L4CX_zone_hist_info_t     VL53L4CX_p_003[VL53L4CX_MAX_USER_ZONES];


} VL53L4CX_zone_histograms_t;
...
} VL53L4CX_zone_calibration_data_t;
...
typedef struct {
  ...
  VL53L4CX_DevicePresetModes         preset_mode;

  VL53L4CX_DeviceZonePreset          zone_preset;
  ...
  VL53L4CX_zone_calibration_data_t   VL53L4CX_p_003[VL53L4CX_MAX_USER_ZONES];


} VL53L4CX_zone_calibration_results_t;
...
typedef struct {
  ...
  uint16_t    peak_rate_mcps[VL53L4CX_NVM_PEAK_RATE_MAP_SAMPLES];


} VL53L4CX_cal_peak_rate_map_t;
...
} VL53L4CX_zone_private_dyn_cfg_t;
...
typedef struct {
  ...
  VL53L4CX_zone_private_dyn_cfg_t VL53L4CX_p_003[VL53L4CX_MAX_USER_ZONES];


} VL53L4CX_zone_private_dyn_cfgs_t;
...
} VL53L4CX_xtalk_calibration_results_t;
...
typedef struct {
  ...
  int32_t   bin_data_sums[VL53L4CX_XTALK_HISTO_BINS];

} VL53L4CX_hist_xtalk_extract_data_t;
...
} VL53L4CX_gain_calibration_data_t;
...
typedef struct {
  ...
  VL53L4CX_DeviceMeasurementModes   measurement_mode;

  VL53L4CX_OffsetCalibrationMode    offset_calibration_mode;

  VL53L4CX_OffsetCorrectionMode     offset_correction_mode;
  ...
  VL53L4CX_ll_version_t                 version;


  VL53L4CX_ll_driver_state_t            ll_state;


  VL53L4CX_GPIO_interrupt_config_t      gpio_interrupt_config;


  VL53L4CX_customer_nvm_managed_t       customer;
  VL53L4CX_cal_peak_rate_map_t          cal_peak_rate_map;
  VL53L4CX_additional_offset_cal_data_t add_off_cal_data;
  VL53L4CX_dmax_calibration_data_t      fmt_dmax_cal;
  VL53L4CX_dmax_calibration_data_t      cust_dmax_cal;
  VL53L4CX_gain_calibration_data_t      gain_cal;
  VL53L4CX_user_zone_t                  mm_roi;
  VL53L4CX_optical_centre_t             optical_centre;
  VL53L4CX_zone_config_t                zone_cfg;


  VL53L4CX_tuning_parm_storage_t        tuning_parms;


  uint8_t rtn_good_spads[VL53L4CX_RTN_SPAD_BUFFER_SIZE];


  VL53L4CX_refspadchar_config_t         refspadchar;
  VL53L4CX_ssc_config_t                 ssc_cfg;
  VL53L4CX_hist_post_process_config_t   histpostprocess;
  VL53L4CX_hist_gen3_dmax_config_t      dmax_cfg;
  VL53L4CX_xtalkextract_config_t        xtalk_extract_cfg;
  VL53L4CX_xtalk_config_t               xtalk_cfg;
  VL53L4CX_offsetcal_config_t           offsetcal_cfg;
  VL53L4CX_zonecal_config_t             zonecal_cfg;


  VL53L4CX_static_nvm_managed_t         stat_nvm;
  VL53L4CX_histogram_config_t           hist_cfg;
  VL53L4CX_static_config_t              stat_cfg;
  VL53L4CX_general_config_t             gen_cfg;
  VL53L4CX_timing_config_t              tim_cfg;
  VL53L4CX_dynamic_config_t             dyn_cfg;
  VL53L4CX_system_control_t             sys_ctrl;
  VL53L4CX_system_results_t             sys_results;
  VL53L4CX_nvm_copy_data_t              nvm_copy_data;


  VL53L4CX_histogram_bin_data_t         hist_data;
  VL53L4CX_histogram_bin_data_t         hist_xtalk;


  VL53L4CX_xtalk_histogram_data_t       xtalk_shapes;
  VL53L4CX_xtalk_range_results_t        xtalk_results;
  VL53L4CX_xtalk_calibration_results_t  xtalk_cal;
  VL53L4CX_hist_xtalk_extract_data_t    xtalk_extract;


  VL53L4CX_offset_range_results_t       offset_results;


  VL53L4CX_core_results_t               core_results;
  VL53L4CX_debug_results_t              dbg_results;

  VL53L4CX_smudge_corrector_config_t  smudge_correct_config;

  VL53L4CX_smudge_corrector_internals_t smudge_corrector_internals;




  VL53L4CX_low_power_auto_data_t    low_power_auto_data;
  ...
  int32_t  multi_bins_rec[VL53L4CX_BIN_REC_SIZE]
  [VL53L4CX_TIMING_CONF_A_B_SIZE][VL53L4CX_HISTOGRAM_BUFFER_SIZE];

  int16_t PreviousRangeMilliMeter[VL53L4CX_MAX_RANGE_RESULTS];
  uint8_t PreviousRangeStatus[VL53L4CX_MAX_RANGE_RESULTS];
  uint8_t PreviousExtendedRange[VL53L4CX_MAX_RANGE_RESULTS];
  uint8_t PreviousRangeActiveResults;
  uint8_t PreviousStreamCount;
} VL53L4CX_LLDriverData_t;
...
typedef struct {
  ...
  VL53L4CX_range_results_t             range_results;


  VL53L4CX_zone_private_dyn_cfgs_t     zone_dyn_cfgs;


  VL53L4CX_zone_results_t              zone_results;
  VL53L4CX_zone_histograms_t           zone_hists;
  VL53L4CX_zone_calibration_results_t  zone_cal;

} VL53L4CX_LLDriverResults_t;
...
typedef struct {
  ...
  uint16_t  target_reflectance_for_dmax[VL53L4CX_MAX_AMBIENT_DMAX_VALUES];

} VL53L4CX_dmax_reflectance_array_t;
...
typedef struct {
  ...
  uint16_t   VL53L4CX_p_020;

  uint16_t   rate_data[VL53L4CX_NO_OF_SPAD_ENABLES];
  ...
  do { \
    ...
    if (__FUNCTION_ID__) { \
      if (__STATUS__ == __ERROR_STATUS_CHECK__) { \
        __STATUS__ = VL53L4CX_ERROR_NONE; \
...
#define VL53L4CX_COPYSTRING(str, ...) \
  (strncpy(str, ##__VA_ARGS__, VL53L4CX_MAX_STRING_LENGTH-1))
