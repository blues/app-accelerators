...
#ifndef _VL53L4CX_PRESET_SETUP_H_
#define _VL53L4CX_PRESET_SETUP_H_
...
enum VL53L4CX_Tuning_t {
  VL53L4CX_TUNING_VERSION = 0,
  VL53L4CX_TUNING_PROXY_MIN,
  VL53L4CX_TUNING_SINGLE_TARGET_XTALK_TARGET_DISTANCE_MM,
  VL53L4CX_TUNING_SINGLE_TARGET_XTALK_SAMPLE_NUMBER,
  VL53L4CX_TUNING_MIN_AMBIENT_DMAX_VALID,
  VL53L4CX_TUNING_MAX_SIMPLE_OFFSET_CALIBRATION_SAMPLE_NUMBER,
  VL53L4CX_TUNING_XTALK_FULL_ROI_TARGET_DISTANCE_MM,
  VL53L4CX_TUNING_SIMPLE_OFFSET_CALIBRATION_REPEAT,
  VL53L4CX_TUNING_XTALK_FULL_ROI_BIN_SUM_MARGIN,
  VL53L4CX_TUNING_XTALK_FULL_ROI_DEFAULT_OFFSET,
  VL53L4CX_TUNING_ZERO_DISTANCE_OFFSET_NON_LINEAR_FACTOR,
  VL53L4CX_TUNING_MAX_TUNABLE_KEY
};
...
#endif /* _VL53L4CX_PRESET_SETUP_H_ */
