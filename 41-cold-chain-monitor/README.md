...
- [Notecarrier B](https://shop.blues.com/collections/notecarrier/products/notecarrier-b?utm_source=dev-blues&utm_medium=web&utm_campaign=store-link)
- Molex Antenna 213353 (included with Notecarrier-B purchase)
- [LTE Cat-1 Notecard (North America, EMEA)](https://shop.blues.com/collections/notecard?utm_source=dev-blues&utm_medium=web&utm_campaign=store-link)
...
- [Molex Antenna 209142](https://shop.blues.com/collections/accessories/products/flexible-cellular-or-wi-fi-antenna?utm_source=dev-blues&utm_medium=web&utm_campaign=store-link)
...
[firmware version 4.4.1](https://dev.blues.io/notecard/notecard-firmware-releases/#v3-5-1-october-7-2022)
or higher. The simplest way to update firmware is to do an
[over-the-air (OTA) update](https://dev.blues.io/notecard/notecard-walkthrough/updating-notecard-firmware#ota-dfu-with-notehub).
